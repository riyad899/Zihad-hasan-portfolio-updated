export default function About() {
  return (
    <section id="about" className="py-20" style={{ background: '#000000' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 w-64 h-64 bg-blue-600 rounded-full opacity-10 -z-10" />
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-6">
              <div className="p-4 rounded-lg shadow" style={{ background: 'linear-gradient(90deg, #ff6b6b, #ffd93d)' }}>
                <p className="text-3xl font-bold text-white">6+</p>
                <p className="text-white text-sm">Leadership & Volunteer Roles</p>
              </div>
              <div className="p-4 rounded-lg shadow" style={{ background: 'linear-gradient(90deg, #ff6b6b, #ffd93d)' }}>
                <p className="text-3xl font-bold text-white">5+</p>
                <p className="text-white text-sm">Professional Certifications</p>
              </div>
              <div className="p-4 rounded-lg shadow" style={{ background: 'linear-gradient(90deg, #ff6b6b, #ffd93d)' }}>
                <p className="text-3xl font-bold text-white">8+</p>
                <p className="text-white text-sm">Technologies & Libraries</p>
              </div>
              <div className="p-4 rounded-lg shadow" style={{ background: 'linear-gradient(90deg, #ff6b6b, #ffd93d)' }}>
                <p className="text-3xl font-bold text-white">5+</p>
                <p className="text-white text-sm">Years of Tech Experience</p>
              </div>
            </div>
          </div>
        </div>
