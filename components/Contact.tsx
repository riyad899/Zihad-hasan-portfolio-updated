          ...
          <div className="space-y-8">
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-100 hover:bg-blue-600 hover:text-white rounded-full flex items-center justify-center transition-colors duration-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg focus:ring-2 outline-none transition-all text-white"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 rounded-lg focus:ring-2 outline-none transition-all resize-none text-white"
                  style={{ background: '#0a0a0a', border: '1px solid #333' }}
              ...
              <button
                type="submit"
                className="w-full px-8 py-3 text-white rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl"
